  ...
  <div class="container-fluid">
    ...
    <div class=" collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav mx-auto ">
        <li class="nav-item">
          <a class="nav-link mx-2 active" aria-current="page" href="">หน้าหลัก</a>
        </li>
...
<center><h1>ยินดีต้อนรับสู่หน้าร้านค้าของเรา</h1></center>
    <div class="container">
    ...
    <div class="container">
        <div class="row g-3">
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card">
                    <img src="https://i.pinimg.com/originals/16/3d/a0/163da0d2fc8a702d318b9417d19cebb0.jpg" class="card-img-top" alt="A Street in Europe">
                    <div class="card-body">
                        <h5 class="card-title">ขายดีอันดับ 1</h5>
                        <p class="card-text">Nagatoro</p>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card">
                    <img src="https://i.ytimg.com/vi/o40ISy1erjE/maxresdefault.jpg" class="card-img-top" alt="London">
                    <div class="card-body">
                        <h5 class="card-title">ขายดีอันดับ 2</h5>
                        <p class="card-text">watamote สาวมืดมนอลวนหารัก</p>
                        <a href="#" class="btn btn-primary">อ่านเพิ่มเติม</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card">
                    <img src="https://readthecloud.co/wp-content/uploads/2021/09/detective-conan-architecture-6-750x567.jpg" class="card-img-top" alt="New York">
                    <div class="card-body">
                        <h5 class="card-title">ขายดีอันดับ 3</h5>
                        <p class="card-text">นักสืบโคนัน</p>
                        <a href="#" class="btn btn-primary">อ่านเพิ่มเติม</a>
                    </div>
                </div>
            </div>
